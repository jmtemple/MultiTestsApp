//
//  TraceShapeCognitiveViewController.swift
//  MultiTestsApp
//
//  Created by Joseph Han on 9/26/17.
...
class TraceShapeCognitiveViewController: UIViewController, JotStrokeDelegate, UIGestureRecognizerDelegate, AVAudioRecorderDelegate {
    ...
    override func viewDidLoad() {
        ...
        fileWriter.write(text: "\(Utils.timeOnly()), Trace Shape Cognitive Game Begins")
        ...
        audioRecorder.startRecording(fileName: "\(fileName)_TraceCognitive_\(Date().timeIntervalSince1970)")
        ...
        /*
        let alert = UIAlertController(title: "Instructions", message: "Trace the following shapes while listing the months of the year backwards.", preferredStyle: UIAlertControllerStyle.alert)
    ...
    @IBAction func submitButton(_ sender: AnyObject) {
        ...
        if (points.count > 0) { // make sure there are points to analyze
            ...
            if(!firstSubmit){
                ...
                fileWriter.write(text: "\(Utils.timeOnly()), Trace Shape Cognitive Game End")
            }
